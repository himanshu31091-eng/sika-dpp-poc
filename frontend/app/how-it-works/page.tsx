...
const sections = [
  {
    ...
    content: 'The Sika Public Document Repository satisfies EU Construction Products Regulation (CPR) requirements for public document access. It provides clean separation between internal EDMS (Optimal Systems) and the public-facing document delivery layer.',
    items: [
  ...
  },
  {
    ...
    content: 'URL stability is the core requirement of the EU CPR Digital Product Passport. URLs must remain valid for a minimum of 10 years after publication.',
    items: [
      ...
      'Example: sikaflex-221--tds-en, sika-top-122--sds-de',
  ...
  },
  {
    ...
    content: 'All document types required by the EU CPR Digital Product Passport specification are supported.',
    items: [
  ...
  },
  {
    ...
    content: 'Internal Sika metadata is never exposed to public users. Separation is enforced at the API model level.',
    items: [
  ...
  },
  {
    ...
    content: 'Designed to integrate with Sika\'s existing EDMS (Optimal Systems / yuuvis-rad) as the external-facing public layer.',
    items: [
      ...
      <main className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">System documentation and feature reference</p>
              </div>
            </div>
            <button
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <div className="mt-8 text-center text-xs text-gray-400 pb-8 no-print">
            Sika Public Document Repository - POC v1.0 - Built for EU CPR Compliance
          </div>
        </div>
      </main>
    </>
