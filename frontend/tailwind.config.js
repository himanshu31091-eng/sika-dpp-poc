  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'red':     '0 4px 14px rgba(204,0,0,0.25)',
        'red-sm':  '0 2px 8px  rgba(204,0,0,0.2)',
        'inner-sm': 'inset 0 1px 2px rgba(0,0,0,0.06)',
      },
      backgroundImage: {
        'hero-gradient':   'linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #0f172a 100%)',
        'red-gradient':    'linear-gradient(135deg, #CC0000 0%, #ff2222 100%)',
      ...
      keyframes: {
        ...
        'pulse-ring': {
          '0%':   { boxShadow: '0 0 0 0 rgba(204,0,0,0.25)' },
          '70%':  { boxShadow: '0 0 0 8px rgba(204,0,0,0)' },
